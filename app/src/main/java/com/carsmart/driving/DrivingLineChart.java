...
public class DrivingLineChart extends View {
    ...
    public DrivingLineChart(Context context) {
        this(context, null);
    }

    public DrivingLineChart(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DrivingLineChart(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                canvas.drawLine(x, y, x, baseY, mPaint);    //柱图
                x = x2;
                y = y2;
            }
        }
